  ...
  mounted() {
    ...
    this.queryData().then(res => {
      ...
      console.log(res);
        ...
        {
            this.$set(this.orders[i], "year", this.orders[i].appointTime[0] + this.orders[i].appointTime[1] + this.orders[i].appointTime[2] + this.orders[i].appointTime[3]);
            this.$set(this.orders[i], "month", this.orders[i].appointTime[0] + this.orders[i].appointTime[1] + this.orders[i].appointTime[2] + this.orders[i].appointTime[3]);
            this.$set(this.orders[i], "day", this.orders[i].appointTime[0] + this.orders[i].appointTime[1] + this.orders[i].appointTime[2] + this.orders[i].appointTime[3]);
            this.$set(this.orders[i], "hour", this.orders[i].appointTime[0] + this.orders[i].appointTime[1] + this.orders[i].appointTime[2] + this.orders[i].appointTime[3]);
            this.$set(this.orders[i], "minute", this.orders[i].appointTime[0] + this.orders[i].appointTime[1] + this.orders[i].appointTime[2] + this.orders[i].appointTime[3]);
            this.$set(this.orders[i], "second", this.orders[i].appointTime[0] + this.orders[i].appointTime[1] + this.orders[i].appointTime[2] + this.orders[i].appointTime[3]);
            console.log(this.orders[i]);
            /*
            this.orders[i].month = this.orders[i].appointTime[4] + this.orders[i].appointTime[5];
            this.orders[i].day = this.orders[i].appointTime[6] + this.orders[i].appointTime[7];
            this.orders[i].hour = this.orders[i].appointTime[8] + this.orders[i].appointTime[9];
            this.orders[i].minute = this.orders[i].appointTime[10] + this.orders[i].appointTime[11];
            this.orders[i].second = this.orders[i].appointTime[12] + this.orders[i].appointTime[13];*/
        }
