    ...
    <div> 
      ...
      <el-card :body-style="{ padding: '0px'}" v-for="(item,index) in orders" :key="index">
          <div style="padding: 14px;" :key="index">
            <div>
            <span class="name">{{orders[index].patTime}}&nbsp;&nbsp;</span>
    ...
    this.queryData().then(res => {
      ...
      console.log(res);
        ...
        for (var i = 0; i < length; i++)
        {
            ...
            this.$set(this.orders[i], "month", this.orders[i].appointTime[4] + this.orders[i].appointTime[5]);
            this.$set(this.orders[i], "day", this.orders[i].appointTime[6] + this.orders[i].appointTime[7]);
            this.$set(this.orders[i], "hour", this.orders[i].appointTime[8] + this.orders[i].appointTime[9]);
            this.$set(this.orders[i], "minute", this.orders[i].appointTime[10] + this.orders[i].appointTime[11]);
            this.$set(this.orders[i], "second", this.orders[i].appointTime[12] + this.orders[i].appointTime[13]);
