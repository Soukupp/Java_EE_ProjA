    ...
    this.queryData().then(res => {
      ...
      console.log(res);
        ...
        for (var i = 0; i < length; i++)
        {
            ...
            this.$set(this.orders[i], "month", this.orders[i].payTime[0] + this.orders[i].payTime[1] + this.orders[i].payTime[2] + this.orders[i].payTime[3]);
            this.$set(this.orders[i], "day", this.orders[i].payTime[0] + this.orders[i].payTime[1] + this.orders[i].payTime[2] + this.orders[i].payTime[3]);
            this.$set(this.orders[i], "hour", this.orders[i].payTime[0] + this.orders[i].payTime[1] + this.orders[i].payTime[2] + this.orders[i].payTime[3]);
            this.$set(this.orders[i], "minute", this.orders[i].payTime[0] + this.orders[i].payTime[1] + this.orders[i].payTime[2] + this.orders[i].payTime[3]);
            this.$set(this.orders[i], "second", this.orders[i].payTime[0] + this.orders[i].payTime[1] + this.orders[i].payTime[2] + this.orders[i].payTime[3]);
