  ...
  <el-container>
        <Header />
          <el-container>
            ...
            <span @click="linkToGetQualification()" class="sub"><i class="iconfont icon-person_add"></i>成为行家 <i class="iconfont icon-keyboard_arrow_right"></i></span>
            <el-dialog
            title="提交信息"
            ...
            <span @click="personalExpert" class="sub"><i class="iconfont icon-contacts"></i>我的行家信息 <i class="iconfont icon-keyboard_arrow_right"></i></span>
  ...
  methods: {
    ...
    personalExpert() {
      ...
      data.append("userId", this.userId);
        ...
        var config = {
            method: 'post',
            url: 'http://localhost:8080/user/isExpert',
            data: data
            }
            var that = this;
            axios(config)
