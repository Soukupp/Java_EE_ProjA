...
export default {
    ...
    methods: {
        ...
        linkToMessages() {
            ...
            var config = {
        method: 'post',
        url: 'http://localhost:8080/favoritedirs-expert/CreateDirsByUserid',
        data: data,
  }
    ...
    mounted() {
        ...
        console.log("ExpertDetail的userId"+this.userId);
