        ...
        <el-container>
          ...
          <el-container>
              ...
              <el-card>
                  ...
                  <span class="name">{{ExpertDetailInfo.name}}</span>
                  <span class="title">{{ExpertDetailInfo.title}}</span>
                  <div class="infos">
                  <span class="sub"><i class="iconfont icon-dingwei"></i>{{ExpertDetailInfo.city}}</span>
                  ...
                  <span class="topics"><i style="color:gray; font-size: 20px;">#&nbsp;</i>{{ item }}</span>
                  </div>
                </div>
                <br>
                <div>
                ...
                <span class="subtitle" >用户评价</span>
                  <el-card v-for="(item,index1) in ExpertDetailInfo.comments" :key="index1">
                 
                  <span>{{ item.name }}</span>   
                  
                  <span style="float:right;">{{ item.time }}</span>     
                  <br>
                  <div style="margin-top:12px; margin-bottom:8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ item.content }}</div>    
                  <div style="float:right; margin-bottom:8px;"><Test5 :fatherScore="item.rating"/></div>
                  </el-card>
                  <div class="btns">
                      <br>
...
export default {
    ...
    this.ExpertDetailInfo = res.data;
        console.log(this.ExpertDetailInfo);
        })
    }
}
</script>
