    ...
    var that = this;
      axios(config)
        .then(function (response) {
          ...
          that.userInfo = JSON.parse(response.data);
          console.log("userInfo"+that.userInfo.phone);
          console.log("temp是" + temp);
          console.log("response.data.isExpert是"+temp.isExpert);
          console.log("response.data.phone是"+temp.phone);
          console.log("response.data是"+temp);
